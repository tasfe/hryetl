 ...
 * @author Chris
 */
public class TableInputVarcharMetaInjection implements StepMetaInjectionInterface {
  ...
  public TableInputVarcharMetaInjection( TableInputVarcharMeta meta ) {
    this.meta = meta;
  }
  ...
  public TableInputVarcharMeta getMeta() {
    return meta;
  }
}
