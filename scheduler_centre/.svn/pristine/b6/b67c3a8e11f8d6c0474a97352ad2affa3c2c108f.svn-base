...
Ext.define('banggo.view.taskManager.AddUserGroupForm', {
	extend : 'Ext.form.Panel',
	alias : 'widget.addUserGroupForm',
	border : 0,
	...
	buttons : [ {
		...
		text : '保存',
		id : 'finishAddUserGroupFormId'
	}, {
		text : '重置',
		id : 'resetAddUserGroupFormBtnId'
	}, {
		text : '关闭',
		id : 'closeAddUserGroupFormBtnId'
	} ],
