DROP TABLE K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D;

CREATE TABLE K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D
(
...
COMMENT ON TABLE K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D IS '充值支付订单';

COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.PAYMENT_VOUCHER_NO IS '支付凭证号，主键，统一凭证';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.TRADE_VOUCHER_NO IS '订单凭证号';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.PRODUCT_CODE IS '支付产品编码';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.MEMBER_ID IS '客户ID';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.ACCOUNT_NO IS '用户账户';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.AMOUNT IS '金额';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.FEE IS '费用';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.PAY_MODE IS '支付模式';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.PAY_CHANNEL IS '支付渠道';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.REMARK IS '支付说明';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.GMT_PAY_SUBMIT IS '支付提交时间';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.PAYMENT_STATUS IS '支付状态';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.EXT IS '扩展参数';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.BIZ_PAYMENT_SEQ_NO IS '业务支付流水号';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.BIZ_PAYMENT_STATE IS '业务支付状态';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.BIZ_SUB_STATE IS '业务支付子状态';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.INST_PAY_NO IS '机构支付编码';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.GMT_PAID IS '支付完成时间';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.ACCESS_CHANNEL IS '终端类型';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.GMT_CREATE IS '创建时间';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.GMT_MODIFIED IS '修改时间';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.MERCHANT_NOTIFY_STATUS IS '商户通知状态';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.USER_NOTIFY_STATUS IS '用户通知状态';

COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.DW_CREATE_TIME IS 'DW创建时间';
COMMENT ON COLUMN K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D.DW_MODIFIED_TIME IS 'DW更新时间';


CREATE INDEX K_TRADE.IDX_DEPOSIT_PMT_ORDER_MODIFIED on K_TRADE.DWD_DEPOSIT_PAYMENT_ORDER_D(GMT_MODIFIED);
