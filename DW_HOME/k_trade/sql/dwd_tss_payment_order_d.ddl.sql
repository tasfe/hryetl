CREATE TABLE K_TRADE.DWD_TSS_PAYMENT_ORDER_D  
(
...
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.PAYMENT_VOUCHER_NO IS '支付凭证号';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.PAYMENT_SOURCE_VOUCHER_NO IS '支付原始凭证号';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.ORIG_PAYMENT_VOUCHER_NO IS '原支付凭证号';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.BIZ_PRODUCT_CODE IS '业务产品编码';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.IS_DUPLICATE IS '是否重复支付';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.PAYMENT_TYPE IS '支付类型01付款	 
02结算	 
03退结算	 
04退付款	 
05退结算回滚	回滚退结算成功的订单';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.PAYMENT_CODE IS '支付编码';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.AMOUNT IS '支付金额';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.STATUS IS '支付状态';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.GMT_SUBMIT IS '支付提交时间';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.ACCESS_CHANNEL IS '终端类型';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.ERROR_CODE IS '错误编码';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.ERROR_MSG IS '错误信息';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.GMT_CREATE IS '创建时间';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.GMT_MODIFIED IS '修改时间';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.PAYMENT_TAG IS '支付标签相对于支付类型来说比较自由，可以认为是支付类型下的子分类
INST_SETTLE:即时结算';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.TRADE_VOUCHER_NO IS '交易凭证号';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.PROCESSOR_ID IS '处理器ID';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.EXTENSION IS '扩展信息';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.MEMO IS '备注';
COMMENT ON TABLE K_TRADE.DWD_TSS_PAYMENT_ORDER_D IS '支付订单';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.DW_CREATE_TIME IS 'DW 创建时间';
COMMENT ON COLUMN K_TRADE.DWD_TSS_PAYMENT_ORDER_D.DW_MODIFIED_TIME IS 'DW 修改时间';
