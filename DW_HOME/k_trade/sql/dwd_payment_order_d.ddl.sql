DROP TABLE K_TRADE.DWD_PAYMENT_ORDER_D; 

CREATE TABLE K_TRADE.DWD_PAYMENT_ORDER_D 
(
  PAYMENT_SEQ_NO VARCHAR2(32 BYTE) NOT NULL PRIMARY KEY
...
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.PAYMENT_SEQ_NO IS 'YYYYMMDD||CODE[2]||SEQ_PAYMENT_ORDER[8]';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.BIZ_PAYMENT_SEQ_NO IS '业务支付订单流水号';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.RELATE_PAYMENT_SEQ_NO IS '相关支付流水号';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.PAYMENT_TYPE IS 'FI,入款,01
FO,出款,02
FT,转账,03
RI,退款到卡,04
RT,退款到帐户,05
...
PA,预授权,07
PC,预授权撤销,08';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.PRODUCT_CODE IS '产品编码';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.PRODUCT_ORDER_NO IS '产品订单号，产品体系内生成';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.PAYMENT_ORDER_NO IS '支付订单号，收单服务支付订单流水号';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.GMT_PAYMENT IS '支付发起时间';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.GMT_CREATE IS '创建时间';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.GMT_MODIFIED IS '最后修改时间';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.MEMO IS '备注';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.PAY_MODE IS '支付模式';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.PAY_CHANNEL IS '支付渠道';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.PS_CODE IS '支付服务码'; 
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.DW_CREATE_TIME IS 'DW 创建时间';
COMMENT ON COLUMN K_TRADE.DWD_PAYMENT_ORDER_D.DW_MODIFIED_TIME IS 'DW 修改时间';


CREATE INDEX K_TRADE.IDX_PAYMENT_ORDER_MODIFIED on K_TRADE.DWD_PAYMENT_ORDER_D(GMT_MODIFIED);
