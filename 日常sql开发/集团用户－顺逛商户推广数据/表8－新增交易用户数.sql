...
T1.sjhm 办公手机号码,
T1.PROMOTED_ID ,
T5.FRIST_TRADE_DATE 被推荐人首次交易日期,
T4.MOBILE 被推荐人手机号,
...
left join bidata.s_s61_t6110 t3
on t0.PROMOTED_ID =t3.f01
...
left join TMP_USER_FIRST_TRADE t5
on T1.PROMOTED_KJTID=t5.KJTID
order by T1.hryid
--where T4.ctime<to_date('20170501','yyyymmdd') 
--and T4.CTIME>=to_date('20170401','yyyymmdd')
) T
--where to_char(T.被推荐人注册时间,'yyyymm')='201704'
where T.被推荐人首次交易日期 between '20170501' and '20170531'
group by T.被推荐人类型
;