...
t5.F10 被推荐人认证时间,
NVL(T2.P2P_ORDER_COUNT,0) 被推荐人P2P投资次数,
NVL(T2.P2P_INVEST_AMT,0) 被推荐人P2P投资金额,
NVL(T3.fund_order_count,0) 被推荐人基金投资次数,
NVL(T3.fund_invest_amount,0) 被推荐人基金投资金额,
NVL(T3.fund_order_count,0)+NVL(T2.P2P_ORDER_COUNT,0) 被推荐人总投资次数,
NVL(T3.fund_invest_amount,0)+NVL(T2.P2P_INVEST_AMT,0) 被推荐人总投资金额
from (
select 
t0.PROMOTED_ID 
